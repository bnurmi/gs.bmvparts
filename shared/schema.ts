...
// Generated from migrations/schema.ts so runtime imports align with DB schema.
// ---------------------------------------------------------------------------
export const insertCarSchema = createInsertSchema(cars);
export type Car = typeof cars.$inferSelect;
export type InsertCar = typeof cars.$inferInsert;
export const insertPartPricingSchema = createInsertSchema(partPricing);
export type PartPricing = typeof partPricing.$inferSelect;
export type InsertPartPricing = typeof partPricing.$inferInsert;
...
export const insertExternalCatalogPartSchema = createInsertSchema(externalCatalogParts);
export type ExternalCatalogPart = typeof externalCatalogParts.$inferSelect;
export type InsertExternalCatalogPart = typeof externalCatalogParts.$inferInsert;
export const insertApiKeySchema = createInsertSchema(apiKeys);
export type ApiKey = typeof apiKeys.$inferSelect;
export type InsertApiKey = typeof apiKeys.$inferInsert;
export const insertBmwModelSchema = createInsertSchema(bmwModels);
export type BmwModel = typeof bmwModels.$inferSelect;
export type InsertBmwModel = typeof bmwModels.$inferInsert;
export const insertSessionSchema = createInsertSchema(session);
export type Session = typeof session.$inferSelect;
export type InsertSession = typeof session.$inferInsert;
export const insertUserCarSchema = createInsertSchema(userCars);
export type UserCar = typeof userCars.$inferSelect;
export type InsertUserCar = typeof userCars.$inferInsert;
export const insertPartCrossReferenceSchema = createInsertSchema(partCrossReferences);
export type PartCrossReference = typeof partCrossReferences.$inferSelect;
export type InsertPartCrossReference = typeof partCrossReferences.$inferInsert;
export const insertVinCacheSchema = createInsertSchema(vinCache);
...
export const insertRealoemCheckedPartSchema = createInsertSchema(realoemCheckedParts);
export type RealoemCheckedPart = typeof realoemCheckedParts.$inferSelect;
export type InsertRealoemCheckedPart = typeof realoemCheckedParts.$inferInsert;
export const insertProvisionedAccountSchema = createInsertSchema(provisionedAccounts);
export type ProvisionedAccount = typeof provisionedAccounts.$inferSelect;
export type InsertProvisionedAccount = typeof provisionedAccounts.$inferInsert;
...
export const insertLinkClickSchema = createInsertSchema(linkClicks);
export type LinkClick = typeof linkClicks.$inferSelect;
export type InsertLinkClick = typeof linkClicks.$inferInsert;
export const insertRealoemVinCacheSchema = createInsertSchema(realoemVinCache);
export type RealoemVinCache = typeof realoemVinCache.$inferSelect;
export type InsertRealoemVinCache = typeof realoemVinCache.$inferInsert;
export const insertRealoemChassisScrapeJobSchema = createInsertSchema(realoemChassisScrapeJobs);
export type RealoemChassisScrapeJob = typeof realoemChassisScrapeJobs.$inferSelect;
export type InsertRealoemChassisScrapeJob = typeof realoemChassisScrapeJobs.$inferInsert;
export const insertHubEditorialSchema = createInsertSchema(hubEditorial);
export type HubEditorial = typeof hubEditorial.$inferSelect;
export type InsertHubEditorial = typeof hubEditorial.$inferInsert;
export const insertCategoryEditorialSchema = createInsertSchema(categoryEditorial);
export type CategoryEditorial = typeof categoryEditorial.$inferSelect;
export type InsertCategoryEditorial = typeof categoryEditorial.$inferInsert;
export const insertPartEditorialNoteSchema = createInsertSchema(partEditorialNotes);
export type PartEditorialNote = typeof partEditorialNotes.$inferSelect;
export type InsertPartEditorialNote = typeof partEditorialNotes.$inferInsert;
export const insertLanguageRequestStatSchema = createInsertSchema(languageRequestStats);
export type LanguageRequestStat = typeof languageRequestStats.$inferSelect;
export type InsertLanguageRequestStat = typeof languageRequestStats.$inferInsert;
export const insertBootstrapLockSchema = createInsertSchema(bootstrapLocks);
export type BootstrapLock = typeof bootstrapLocks.$inferSelect;
export type InsertBootstrapLock = typeof bootstrapLocks.$inferInsert;
export const insertSaCodeSchema = createInsertSchema(saCodes);
export type SaCode = typeof saCodes.$inferSelect;
export type InsertSaCode = typeof saCodes.$inferInsert;
export const insertPaintCodeSchema = createInsertSchema(paintCodes);
export type PaintCode = typeof paintCodes.$inferSelect;
export type InsertPaintCode = typeof paintCodes.$inferInsert;
export const insertUpholsteryCodeSchema = createInsertSchema(upholsteryCodes);
export type UpholsteryCode = typeof upholsteryCodes.$inferSelect;
export type InsertUpholsteryCode = typeof upholsteryCodes.$inferInsert;
export const insertVinFactoryOptionSchema = createInsertSchema(vinFactoryOptions);
export type VinFactoryOption = typeof vinFactoryOptions.$inferSelect;
export type InsertVinFactoryOption = typeof vinFactoryOptions.$inferInsert;
export const insertSubcategoryRealoemMapSchema = createInsertSchema(subcategoryRealoemMap);
export type SubcategoryRealoemMap = typeof subcategoryRealoemMap.$inferSelect;
export type InsertSubcategoryRealoemMap = typeof subcategoryRealoemMap.$inferInsert;
export const insertRealoemAuditFindingSchema = createInsertSchema(realoemAuditFindings);
export type RealoemAuditFinding = typeof realoemAuditFindings.$inferSelect;
export type InsertRealoemAuditFinding = typeof realoemAuditFindings.$inferInsert;
export const insertRealoemUnmatchedDiagramSchema = createInsertSchema(realoemUnmatchedDiagrams);
export type RealoemUnmatchedDiagram = typeof realoemUnmatchedDiagrams.$inferSelect;
export type InsertRealoemUnmatchedDiagram = typeof realoemUnmatchedDiagrams.$inferInsert;
export const insertRealoemVehicleSchema = createInsertSchema(realoemVehicles);
export type RealoemVehicle = typeof realoemVehicles.$inferSelect;
export type InsertRealoemVehicle = typeof realoemVehicles.$inferInsert;
export const insertBmvVinHomeCopySchema = createInsertSchema(bmvVinHomeCopy);
export type BmvVinHomeCopy = typeof bmvVinHomeCopy.$inferSelect;
export type InsertBmvVinHomeCopy = typeof bmvVinHomeCopy.$inferInsert;
export const insertBmvVinBrandDecoderCopySchema = createInsertSchema(bmvVinBrandDecoderCopy);
export type BmvVinBrandDecoderCopy = typeof bmvVinBrandDecoderCopy.$inferSelect;
export type InsertBmvVinBrandDecoderCopy = typeof bmvVinBrandDecoderCopy.$inferInsert;
export const insertBmvVinFacetBlurbSchema = createInsertSchema(bmvVinFacetBlurb);
export type BmvVinFacetBlurb = typeof bmvVinFacetBlurb.$inferSelect;
export type InsertBmvVinFacetBlurb = typeof bmvVinFacetBlurb.$inferInsert;
export const insertBmvVinGuideSchema = createInsertSchema(bmvVinGuide);
export type BmvVinGuide = typeof bmvVinGuide.$inferSelect;
export type InsertBmvVinGuide = typeof bmvVinGuide.$inferInsert;
export const insertBmvVinGlossarySchema = createInsertSchema(bmvVinGlossary);
export type BmvVinGlossary = typeof bmvVinGlossary.$inferSelect;
export type InsertBmvVinGlossary = typeof bmvVinGlossary.$inferInsert;
export const insertRealoemDiagramCanonicalSchema = createInsertSchema(realoemDiagramCanonical);
export type RealoemDiagramCanonical = typeof realoemDiagramCanonical.$inferSelect;
export type InsertRealoemDiagramCanonical = typeof realoemDiagramCanonical.$inferInsert;
export const insertPartChassisAppearanceSchema = createInsertSchema(partChassisAppearances);
export type PartChassisAppearance = typeof partChassisAppearances.$inferSelect;
export type InsertPartChassisAppearance = typeof partChassisAppearances.$inferInsert;
export const insertServicingSpecSchema = createInsertSchema(servicingSpecs);
export type ServicingSpec = typeof servicingSpecs.$inferSelect;
export type InsertServicingSpec = typeof servicingSpecs.$inferInsert;
export const insertServicingFilterPinSchema = createInsertSchema(servicingFilterPins);
export type ServicingFilterPin = typeof servicingFilterPins.$inferSelect;
export type InsertServicingFilterPin = typeof servicingFilterPins.$inferInsert;
export const insertServicingCoverageRequestSchema = createInsertSchema(servicingCoverageRequests);
export type ServicingCoverageRequest = typeof servicingCoverageRequests.$inferSelect;
export type InsertServicingCoverageRequest = typeof servicingCoverageRequests.$inferInsert;
export const insertIstaIngestRunSchema = createInsertSchema(istaIngestRuns);
export type IstaIngestRun = typeof istaIngestRuns.$inferSelect;
export type InsertIstaIngestRun = typeof istaIngestRuns.$inferInsert;
export const insertIstaIngestLockSchema = createInsertSchema(istaIngestLocks);
export type IstaIngestLock = typeof istaIngestLocks.$inferSelect;
export type InsertIstaIngestLock = typeof istaIngestLocks.$inferInsert;
export const insertIstaSspRecordSchema = createInsertSchema(istaSspRecords);
export type IstaSspRecord = typeof istaSspRecords.$inferSelect;
export type InsertIstaSspRecord = typeof istaSspRecords.$inferInsert;
export const insertIstaFubRecordSchema = createInsertSchema(istaFubRecords);
export type IstaFubRecord = typeof istaFubRecords.$inferSelect;
export type InsertIstaFubRecord = typeof istaFubRecords.$inferInsert;
export const insertProxyUsageLogSchema = createInsertSchema(proxyUsageLogs);
export type ProxyUsageLog = typeof proxyUsageLogs.$inferSelect;
export type InsertProxyUsageLog = typeof proxyUsageLogs.$inferInsert;
export const insertProxyProviderConfigSchema = createInsertSchema(proxyProviderConfig);
export type ProxyProviderConfig = typeof proxyProviderConfig.$inferSelect;
export type InsertProxyProviderConfig = typeof proxyProviderConfig.$inferInsert;
...
export const insertVinEnrichmentQueueSchema = createInsertSchema(vinEnrichmentQueue);
export type VinEnrichmentQueue = typeof vinEnrichmentQueue.$inferSelect;
export type InsertVinEnrichmentQueue = typeof vinEnrichmentQueue.$inferInsert;
export const insertSeoContentPageSchema = createInsertSchema(seoContentPages);
export type SeoContentPage = typeof seoContentPages.$inferSelect;
export type InsertSeoContentPage = typeof seoContentPages.$inferInsert;
export const insertSeoRefreshQueueSchema = createInsertSchema(seoRefreshQueue);
export type SeoRefreshQueue = typeof seoRefreshQueue.$inferSelect;
export type InsertSeoRefreshQueue = typeof seoRefreshQueue.$inferInsert;
export const insertVinBackfillDailyCountSchema = createInsertSchema(vinBackfillDailyCounts);
export type VinBackfillDailyCount = typeof vinBackfillDailyCounts.$inferSelect;
export type InsertVinBackfillDailyCount = typeof vinBackfillDailyCounts.$inferInsert;
export const insertAiUsageLogSchema = createInsertSchema(aiUsageLogs);
export type AiUsageLog = typeof aiUsageLogs.$inferSelect;
export type InsertAiUsageLog = typeof aiUsageLogs.$inferInsert;
export const insertAiFaqCacheSchema = createInsertSchema(aiFaqCache);
export type AiFaqCache = typeof aiFaqCache.$inferSelect;
export type InsertAiFaqCache = typeof aiFaqCache.$inferInsert;
export const insertIstaEcuPartSchema = createInsertSchema(istaEcuParts);
export type IstaEcuPart = typeof istaEcuParts.$inferSelect;
export type InsertIstaEcuPart = typeof istaEcuParts.$inferInsert;

export type ProxyScraperName = "etk" | "realoem" | "bimmerwork" | "vin_decoders" | "hash_discovery" | "bmw_firstparty" | "vindecoderz";
export type ProxyProviderName = "evomi_core" | "evomi_premium" | "oxylabs_residential" | "oxylabs_webscraper" | "direct";
export type ProxyRole = "primary" | "backup" | "fallback" | "direct";

export type EnrichmentTabSource = "cache" | "etk" | "bimmerwork" | "vindecoderz" | "mdecoder" | "bmwarchive" | "unknown" | string;
export type EnrichmentSourceMap = Record<string, EnrichmentTabSource | { source?: EnrichmentTabSource; confidence?: number; updatedAt?: string } | null | undefined>;
export type EnrichmentCoverage = { etkCovered?: boolean; missing?: string[]; [key: string]: unknown };
export type IstaRunTrigger = "manual" | "scheduled" | "startup" | string;
export type IstaRunDiffSection = { name?: string; added?: number; changed?: number; removed?: number; [key: string]: unknown };
export type IstaRunDiff = { sections?: IstaRunDiffSection[]; [key: string]: unknown };

export const SERVICING_FLUID_KEYS = ["engineOil", "transmission", "differential", "brakeFluid", "coolant", "powerSteering"] as const;
export const SERVICING_FILTER_KEYS = ["engineOilFilter", "airFilter", "cabinFilter", "fuelFilter", "sparkPlugs"] as const;
...
export type ServicingTrustStatus = "verified" | "inferred" | "unknown" | string;
export type ServicingFluidValue = { value?: string | null; interval?: string | null; notes?: string | null; trust?: ServicingTrustStatus; [key: string]: unknown };
export type ServicingFluidsMap = Partial<Record<ServicingFluidKey, ServicingFluidValue>>;

export const backupScheduleDefaults = { enabled: false, intervalHours: 24, timeOfDay: "03:00" };
export const backupRetentionDefaults = { daily: 7, weekly: 4, monthly: 3 };
export const backupScheduleSchema = z.object({
  enabled: z.boolean().default(false),
  intervalHours: z.number().int().positive().default(24),
  timeOfDay: z.string().default("03:00"),
}).passthrough();
export const backupRetentionSchema = z.object({
  daily: z.number().int().nonnegative().default(7),
  weekly: z.number().int().nonnegative().default(4),
  monthly: z.number().int().nonnegative().default(3),
}).passthrough();
